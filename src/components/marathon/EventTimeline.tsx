    ...
    <section className="py-20 md:py-24 bg-white dots-pattern">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="text-royal font-semibold text-sm tracking-widest uppercase">Race Day Schedule</p>
        ...
        <div className="relative">
          ...
          <div className="grid gap-6 md:gap-8 lg:grid-cols-5 relative z-10">
            {steps.map(({ time, title, icon: Icon, desc }, i) => (
              <div key={title} className="relative flex lg:flex-col items-start lg:items-center gap-4 lg:text-center bg-white rounded-2xl p-5 md:p-6 ring-1 ring-slate-100 shadow-soft hover:shadow-elevated hover:ring-royal/20 transition-all duration-300 group hover-lift h-full">
                ...
                <div>
                  <p className="font-display font-extrabold text-base text-orange">{time}</p>
