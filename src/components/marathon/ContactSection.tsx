  ...
  return (
    <section id="contact" className="py-20 md:py-24 bg-white dots-pattern">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 lg:gap-16">
        <div>
          <p className="text-royal font-semibold text-sm tracking-widest uppercase">Contact Us</p>
          ...
          <ul className="mt-8 space-y-5">
            <li className="flex items-start gap-4">
              <span className="grid place-items-center h-11 w-11 rounded-xl bg-royal/10 text-royal shrink-0"><Mail className="h-5 w-5" /></span>
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-widest">Email</p>
                <a href={`mailto:${EVENT.email}`} className="font-semibold text-charcoal hover:text-royal transition-colors">{EVENT.email}</a>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <span className="grid place-items-center h-11 w-11 rounded-xl bg-royal/10 text-royal shrink-0"><Phone className="h-5 w-5" /></span>
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-widest">Phone</p>
                <a href={`tel:${EVENT.phone}`} className="font-semibold text-charcoal hover:text-royal transition-colors">{EVENT.phone}</a>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <span className="grid place-items-center h-11 w-11 rounded-xl bg-royal/10 text-royal shrink-0"><Mail className="h-5 w-5" /></span>
              <div>
                ...
                <a href={`mailto:${EVENT.supportEmail}`} className="font-semibold text-charcoal hover:text-royal transition-colors">{EVENT.supportEmail}</a>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <span className="grid place-items-center h-11 w-11 rounded-xl bg-royal/10 text-royal shrink-0"><MapPin className="h-5 w-5" /></span>
              <div>
        ...
        <form onSubmit={onSubmit} className="rounded-3xl bg-white border border-slate-100 p-6 md:p-10 space-y-5 shadow-elevated" noValidate>
