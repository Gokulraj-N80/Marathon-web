...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join the 6th Edition of Run Beyond Limits on September 27, 2026 across Chennai, Bengaluru, and Salem. Push your endurance across 21.1K, 10K and 5K categories." },
      { name: "author", content: "Run Beyond Limits" },
      { property: "og:title", content: "Run Beyond Limits 2026 · Run Beyond Limits" },
      { property: "og:description", content: "Join the 6th Edition of Run Beyond Limits on September 27, 2026 across Chennai, Bengaluru, and Salem. Push your endurance across 21.1K, 10K and 5K categories." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Run Beyond Limits 2026 · Run Beyond Limits" },
      { name: "twitter:description", content: "Join the 6th Edition of Run Beyond Limits on September 27, 2026 across Chennai, Bengaluru, and Salem. Push your endurance across 21.1K, 10K and 5K categories." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Inter:wght@400;500;600;700&family=Poppins:wght@600;700;800;900&display=swap" },
      { rel: "preload", href: "/src/assets/background.png", as: "image" },
      { rel: "preload", href: "/src/assets/hero-bg.jpg", as: "image" },
      { rel: "preload", href: "/src/assets/img.png", as: "image" },
    ],
  }),
