...
import { C as MapPin, D as HeartPulse, E as Heart, G as Activity, N as Droplet, O as HeartHandshake, W as ArrowRight, f as ShieldCheck, i as Users, k as Footprints, l as Sparkles, m as Route, o as Trophy, r as Wind, s as Timer } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/RegistrationCTA-BUagi0KE.js
...
function AboutEvent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid gap-12 md:gap-20 md:grid-cols-2 items-center",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "absolute -bottom-8 -right-8 hidden md:block rounded-2xl bg-navy/95 backdrop-blur-xl shadow-glow p-6 max-w-[260px] ring-1 ring-white/15 border-l-4 border-l-orange",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid place-items-center h-14 w-14 rounded-xl bg-orange/15 text-orange shrink-0 animate-pulse-glow",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute -top-4 -left-4 hidden md:flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-md ring-1 ring-white/20 px-4 py-2 animate-float",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-4 w-4 text-orange" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
					className: "mt-3 font-display text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-4 h-1.5 w-20 rounded-full bg-orange" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "prose prose-lg text-white/80 prose-p:leading-relaxed",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-6 text-lg",
						children: "We are excited to announce Run Beyond Limits, happening on 27th September 2026 simultaneously across Chennai, Bengaluru, and Salem. With the theme \"Push Your Endurance\", this year's event continues our mission to raise awareness about fitness, resilience, and personal records, uniting thousands of passionate runners for one powerful cause."
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 text-white/70 leading-relaxed text-lg",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("blockquote", {
					className: "mt-8 border-l-4 border-orange bg-white/5 backdrop-blur-sm rounded-r-2xl pl-6 py-5 pr-4 italic text-white/95 font-semibold text-lg max-w-xl",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: ["Know More ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-5 w-5" })]
					})
				})
			] })]
		})]
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: items$1.map(({ icon: Icon, title, desc, num }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "group bg-white rounded-[1.5rem] p-7 shadow-card border border-slate-100/80 hover:border-navy/20 hover:shadow-card-hover hover-lift relative overflow-hidden transition-all duration-300",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "absolute top-4 right-4 text-5xl font-black text-navy/5 group-hover:text-navy/10 transition duration-300",
							children: num
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "grid place-items-center h-14 w-14 rounded-2xl bg-gradient-to-br from-navy to-charcoal text-white group-hover:scale-110 transition-all duration-300 shadow-soft",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "h-7 w-7" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-6 font-extrabold text-lg text-slate-800 tracking-tight",
							children: title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2.5 text-sm text-slate-500 leading-relaxed",
							children: desc
						})
					]
				}, title))
...
function MarathonDifference() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "py-24 md:py-32 gradient-hero text-white relative overflow-hidden",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-0 pointer-events-none",
				style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-3 font-display text-3xl md:text-5xl lg:text-6xl font-extrabold",
							children: "What Makes Run Beyond Limits Different?"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-4 h-1.5 w-20 mx-auto rounded-full bg-white/40" })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3",
					children: items.map(({ icon: Icon, title, desc }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[1.5rem] bg-white/10 backdrop-blur-xl ring-1 ring-white/15 p-8 hover-lift shadow-soft group hover:bg-white/15 hover:ring-white/25 transition-all duration-300",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid place-items-center h-14 w-14 rounded-2xl bg-white/15 text-white group-hover:scale-110 group-hover:bg-white/20 transition-all duration-300",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "h-7 w-7" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-2.5 text-sm text-white/70 leading-relaxed",
								children: desc
							})
						]
					}, title))
...
function HeartHealthSection() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "py-24 md:py-28 bg-[#F8FAFC] relative overflow-hidden dots-pattern",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						className: "mt-4 font-display text-3xl md:text-5xl lg:text-6xl font-extrabold text-charcoal leading-tight",
					...
					children: tips.map(({ icon: Icon, title, desc }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[1.5rem] bg-white p-6 shadow-card border border-slate-100 hover:border-navy/20 hover:shadow-card-hover hover-lift transition-all duration-300 group",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid place-items-center h-14 w-14 rounded-2xl bg-navy/5 text-navy group-hover:bg-gradient-to-br group-hover:from-navy group-hover:to-charcoal group-hover:text-white transition-all duration-300 shadow-sm",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "h-6 w-6" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "mt-5 font-extrabold text-charcoal text-base md:text-lg",
								children: title
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function RegistrationCTA() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "py-28 md:py-36 relative overflow-hidden gradient-hero text-white",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-0 pointer-events-none",
				style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "absolute inset-0 pointer-events-none",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "absolute top-8 left-8 h-28 w-28 text-white/10" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "absolute bottom-8 right-8 h-48 w-48 text-white/10" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30rem] h-[30rem] rounded-full bg-orange/10 blur-3xl" })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-4 font-display text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight",
						children: "Ready to Protect Your Heart?"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-4 h-1.5 w-20 mx-auto rounded-full bg-white/30" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
