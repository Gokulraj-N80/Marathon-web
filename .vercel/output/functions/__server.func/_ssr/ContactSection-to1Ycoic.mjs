...
//#region node_modules/.nitro/vite/services/ssr/assets/ContactSection-to1Ycoic.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex items-start gap-4 rounded-2xl bg-white p-5 shadow-soft border border-slate-100/60 transition-shadow duration-200 hover:shadow-elevated",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "grid place-items-center h-11 w-11 rounded-xl bg-navy/10 text-navy shrink-0",
								...
								className: "font-semibold text-charcoal hover:text-navy transition-colors",
				...
				onSubmit,
				className: "rounded-3xl bg-white border border-slate-100 p-6 md:p-10 space-y-5 shadow-elevated transition-shadow duration-300 hover:shadow-glow",
				noValidate: true,
				children: [
