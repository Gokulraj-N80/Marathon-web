...
import { A as Flag, B as Check, P as Coffee, S as Medal, U as Award, W as ArrowRight, d as Shirt, g as Plus, h as Rocket, o as Trophy, s as Timer, u as ShoppingBag, y as Minus } from "../_libs/lucide-react.mjs";
import { i as RACES, r as FAQS } from "./marathon-DjS4FD98.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/FAQ-BkyjBx92.js
...
function EventHighlights() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "py-24 md:py-28 bg-background dots-pattern",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: items.map(({ icon: Icon, title, desc, num }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mx-auto grid place-items-center h-14 w-14 rounded-2xl bg-navy/5 text-navy group-hover:bg-gradient-to-br group-hover:from-navy group-hover:to-charcoal group-hover:text-white transition-all duration-500 shadow-sm group-hover:shadow-glow",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-4 font-bold text-charcoal text-sm md:text-base tracking-tight transition-colors duration-300 group-hover:text-navy",
							children: title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function RaceCategories() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		id: "races",
		className: "py-24 md:py-32 bg-[#F8FAFC] dots-pattern",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "text-center max-w-2xl mx-auto mb-16",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-3 text-4xl md:text-6xl font-extrabold text-charcoal tracking-tight",
						children: "Choose Your Challenge"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-4 h-1.5 w-24 mx-auto rounded-full bg-navy" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							r.popular && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full gradient-orange text-white text-[10px] font-black uppercase tracking-widest px-5 py-1.5 shadow-glow animate-pulse-glow",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hidden lg:block absolute left-4 right-4 top-14 h-1.5 bg-gradient-to-r from-royal/20 via-orange/40 to-royal/20 rounded-full -z-10" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: steps.map(({ time, title, icon: Icon, desc }, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "relative flex lg:flex-col items-start lg:items-center gap-4 lg:text-center bg-white rounded-[1.5rem] p-5 md:p-6 ring-1 ring-slate-100 shadow-card hover:shadow-card-hover hover:ring-royal/20 transition-all duration-300 group hover-lift h-full",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-display font-extrabold text-base text-navy",
								children: time
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function FAQ() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		id: "faq",
		className: "py-24 md:py-28 gradient-soft dots-pattern",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: FAQS.map((f, i) => {
					const isOpen = open === i;
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: `rounded-2xl border transition-all duration-300 ${isOpen ? "bg-white border-royal/30 shadow-card-hover scale-[1.01]" : "bg-white border-slate-100 shadow-card hover:border-slate-200/80 hover:shadow-card-hover"}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							className: "w-full text-left flex items-center justify-between gap-4 p-6 md:p-7 cursor-pointer",
							onClick: () => setOpen(isOpen ? null : i),
							"aria-expanded": isOpen,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `font-bold text-sm md:text-base leading-snug transition-colors duration-200 ${isOpen ? "text-navy" : "text-slate-800"}`,
								children: f.q
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `shrink-0 grid place-items-center h-10 w-10 rounded-full transition-all duration-300 ${isOpen ? "gradient-orange text-white rotate-180 shadow-glow" : "bg-navy/5 text-navy hover:bg-navy/10"}`,
							...
							className: "px-6 md:px-7 pb-6 md:pb-7 text-xs md:text-sm text-slate-500 leading-relaxed animate-fade-up",
