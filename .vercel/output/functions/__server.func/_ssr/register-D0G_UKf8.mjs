...
import { i as RACES, n as EVENT, t as CITIES } from "./marathon-DjS4FD98.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as objectType, r as stringType, t as enumType } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/register-D0G_UKf8.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/",
					className: "mt-6 inline-flex rounded-full gradient-orange text-white px-6 py-3 font-semibold",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: STEPS.map((label, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `mx-auto h-9 w-9 rounded-full grid place-items-center text-xs font-bold ${i < step ? "bg-navy text-white" : i === step ? "gradient-orange text-white shadow-glow" : "bg-white text-muted-foreground border border-border"}`,
							children: i < step ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-4 w-4" }) : i + 1
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: `mt-2 text-[10px] md:text-xs font-semibold uppercase tracking-widest ${i === step ? "text-navy" : "text-muted-foreground"}`,
							children: label
						})]
					}, label))
					...
					children: [
						step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: CITIES.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									className: `text-left rounded-2xl p-5 border-2 transition ${cityId === c.id ? "border-navy bg-navy/5 shadow-soft" : "border-border hover:border-navy/30"}`,
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: RACES.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									className: `text-left rounded-2xl p-5 border-2 transition ${raceId === r.id ? "border-navy bg-navy/5 shadow-soft" : "border-border hover:border-navy/30"}`,
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "mt-3 text-orange font-bold",
											children: ["₹", r.fee]
										})
									]
								}, r.id))
						...
						step === 4 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: SIZES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setSize(s),
									className: `h-14 rounded-xl font-bold text-lg border-2 transition ${size === s ? "border-navy bg-navy text-white" : "border-border hover:border-navy/30"}`,
									children: s
								}, s))
							})
						] }),
						step === 5 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl gradient-orange text-white p-5 flex items-center justify-between mt-6",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								onClick: next,
								className: "inline-flex items-center gap-2 rounded-full gradient-orange text-white px-6 py-3 font-semibold shadow-soft hover:scale-105 transition",
