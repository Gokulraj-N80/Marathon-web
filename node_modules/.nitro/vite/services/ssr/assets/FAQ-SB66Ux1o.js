import { i as RACES, r as FAQS } from "./marathon-B7kyZOaQ.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Award, Check, Coffee, Flag, Medal, Minus, Plus, Rocket, Shirt, ShoppingBag, Timer, Trophy } from "lucide-react";
//#region src/components/marathon/EventHighlights.tsx
var items = [
	{
		icon: Timer,
		title: "Timing Chip",
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "mt-4 h-1 w-16 mx-auto rounded-full gradient-cta" })
				]
			}), /* @__PURE__ */ jsx("div", {
				className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 md:gap-6",
				children: items.map(({ icon: Icon, title, desc, num }) => /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/marathon/RaceCategories.tsx
var styles = {
	magenta: {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "mt-4 h-1.5 w-20 mx-auto rounded-full gradient-cta" }),
					/* @__PURE__ */ jsx("p", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
									...
									children: ["Register ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								})]
							})
						]
					}, r.id);
...
//#endregion
//#region src/components/marathon/EventTimeline.tsx
var steps = [
	{
		time: "05:00 AM",
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				className: "relative",
				children: [/* @__PURE__ */ jsx("div", { className: "hidden lg:block absolute left-4 right-4 top-14 h-1.5 bg-gradient-to-r from-royal/20 via-orange/40 to-royal/20 rounded-full -z-10" }), /* @__PURE__ */ jsx("div", {
					className: "grid gap-6 md:gap-8 lg:grid-cols-5 relative z-10",
					children: steps.map(({ time, title, icon: Icon, desc }, i) => /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/marathon/FAQ.tsx
function FAQ() {
...
//#endregion
export { EventHighlights as i, EventTimeline as n, RaceCategories as r, FAQ as t };
