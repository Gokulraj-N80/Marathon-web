...
import { M as Dumbbell, U as ArrowRight, V as Calendar, c as Stethoscope, i as Users, v as Newspaper, z as ChevronDown } from "../_libs/lucide-react.mjs";
import { a as WhyParticipate, i as RegistrationCTA, n as HeartHealthSection, r as MarathonDifference, t as AboutEvent } from "./RegistrationCTA-DbMGZLLo.mjs";
...
import { i as RaceCategories, n as EventTimeline, r as FAQ, t as EventHighlights } from "./FAQ-SB66Ux1o.mjs";
import { n as PressHighlights, t as Gallery } from "./PressHighlights-DoRqiBqN.mjs";
import { t as img_default } from "./img-Rdt-I_xG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-B8HK8RtX.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var background_default = "/assets/background-DyMdkfUM.png";
function HeroSection() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-r from-navy/90 via-navy/50 to-transparent" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-navy/80 via-transparent to-navy/20" }),
...
function Countdown() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative py-24 md:py-32 gradient-hero text-white overflow-hidden",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-0 pointer-events-none",
				style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-royal/20 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute bottom-1/4 right-1/4 w-48 h-48 rounded-full bg-orange/15 blur-3xl" })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-12 grid grid-cols-4 gap-3 md:gap-6 max-w-4xl mx-auto",
						children: cells.map(([label, val]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "font-display text-5xl md:text-8xl font-black tabular-nums tracking-tight text-white drop-shadow-[0_4px_12px_rgba(37,99,235,0.4)] group-hover:text-orange transition-colors duration-300",
...
function Sponsors() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "py-16 md:py-20 bg-white border-y border-border dots-pattern",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-center text-royal font-semibold text-sm tracking-widest uppercase",
				...
				children: partners.map(({ icon: Icon, name }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "p-2 rounded-xl bg-slate-50 group-hover:bg-royal/10 group-hover:text-royal transition-all duration-300 text-slate-400",
