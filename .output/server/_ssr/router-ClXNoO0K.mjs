...
//#region node_modules/.nitro/vite/services/ssr/assets/router-ClXNoO0K.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Dmrfmz5n.css";
...
function Navbar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: `sticky top-0 z-50 w-full transition-all duration-500 ${scrolled ? "bg-white/90 backdrop-blur-xl border-b border-border shadow-soft" : "bg-white/60 backdrop-blur-md border-b border-border/50"}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
			className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between gap-4",
			children: [
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				className: `relative bg-white/95 backdrop-blur-xl border-b border-border shadow-elevated transition-all duration-300 ${open ? "translate-y-0 opacity-100" : "-translate-y-4 opacity-0"}`,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
					className: "px-6 py-4 space-y-1",
					children: [NAV.map((n, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: n.to,
						onClick: (e) => {
							setOpen(false);
							if (n.to === "/" && window.location.pathname === "/") {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								href: "#",
								"aria-label": "social",
								className: "grid place-items-center h-9 w-9 rounded-full bg-white/10 hover:bg-royal transition",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-4 w-4 mt-0.5 text-orange shrink-0" }),
								" ",
								EVENT.location
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex items-start gap-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: "h-4 w-4 mt-0.5 text-orange shrink-0" }),
								" ",
								EVENT.email
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex items-start gap-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "h-4 w-4 mt-0.5 text-orange shrink-0" }),
								" ",
								EVENT.phone
							]
						})
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "© 2026 Run Beyond Limits. All rights reserved." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Run Beyond Limits" })]
			})
		})]
	});
}
...
var Route$7 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Join the 6th Edition of Run Beyond Limits on September 27, 2026 across Chennai, Bengaluru, and Salem. Push your endurance across 21.1K, 10K and 5K categories."
			},
			{
				name: "author",
...
var $$splitComponentImporter$5 = () => import("./routes-B8HK8RtX.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./about-RcVoyhEJ.mjs");
...
var $$splitComponentImporter$3 = () => import("./contact-Dsnw_d6z.mjs");
...
var $$splitComponentImporter$2 = () => import("./event-info-BZsI2tPl.mjs");
...
var $$splitComponentImporter$1 = () => import("./gallery-4P9JswYE.mjs");
var Route$2 = createFileRoute("/gallery")({
	head: () => ({ meta: [{ title: "Gallery · Run Beyond Limits 2026" }, {
		name: "description",
		content: "Moments from previous editions of Run Beyond Limits."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./register-CyEFdybi.mjs");
